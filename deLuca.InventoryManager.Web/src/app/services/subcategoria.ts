...
import { SubcategoriaResponse, CreateSubcategoriaRequest } from '../models/subcategoria.model';
...
export class SubcategoriaService {
  ...
  addSubcategoria(dados: CreateSubcategoriaRequest): Observable<SubcategoriaResponse> {
